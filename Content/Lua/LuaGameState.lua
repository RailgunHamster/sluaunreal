...
function LuaGameState:GetLifetimeReplicatedProps()
	local ELifetimeCondition = import("/Script/CoreUObject.ELifetimeCondition")
	local FVectorType = import("/Script/CoreUObject.Vector")
	return {
		...
		{
			"TeamatePositionsAlways",
			ELifetimeCondition.COND_None,
			EPropertyClass.Array,
			FVectorType,
			RepNotifyCondition = 1,
		},
	}
end
