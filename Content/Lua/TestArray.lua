...
local arrLessGC = slua.Array(EPropertyClass.Struct, import("/Script/CoreUObject.Vector"))
...
local FUserInfo = import("/Script/democpp.UserInfo")
local arrUserInfo = slua.Array(EPropertyClass.Struct, import("/Script/democpp.UserInfo"))
for i = 1, 3 do
